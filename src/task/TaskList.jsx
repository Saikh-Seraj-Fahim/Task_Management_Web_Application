        ...
        <div className="overflow-auto">
            <table className="table-fixed overflow-auto xl:w-full">
                ...
                <tbody>
                    {
                        tasks.map(task =>
                            <tr className="border-b border-[#2E3443] [&>td]:align-baseline 
                            [&>td]:px-4 [&>td]:py-2">
                                <td>
                                ...
                                <td>
                                    <ul className="flex justify-center gap-1.5 flex-wrap">
                                        {task.tags.map(tag =>
                                            <li key={tag}>
                                                <span
                                                    className="inline-block h-5 whitespace-nowrap 
                                                rounded-[45px] bg-[#00D991A1] px-2.5 
                                                text-sm capitalize text-[#F4F5F6]">{tag}</span>
                                            </li>
                                        )}
                                    </ul>
                                </td>
